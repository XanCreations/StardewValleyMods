...
- The code is provided so other modders can **read and learn from it**.
- **Please do not copy, modify, or redistribute** this code in your own projects or uploads.
- All rights reserved by XanCreations(Nexus Mods).

If you'd like to use any part of this code, please contact me first.
